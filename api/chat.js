...
- Publications (IEEE): "Novel Attack Vector to Abuse AWS for Cryptojacking" (ICAAIC 2024), "Navigating the Cloud: A Review of Emerging Trends in Security" (ICSSAS 2024). arXiv: "Koshur Diacritizer: A Byte-Level Sequence-to-Sequence Model for Kashmiri Diacritic Restoration" (arXiv 2606.15883, with Haq Nawaz Malik and Faizan Iqbal — the first dedicated neural model for Kashmiri diacritic restoration, 77.5% expert accuracy, released a 23.7k aligned sentence-pair dataset). arXiv: "Koshur Pixel: A Large-Scale Synthetic OCR Dataset for Kashmiri" (arXiv 2606.23144, with Haq Nawaz Malik and Faizan Iqbal — a synthetic OCR dataset of 613,078 image-text pairs rendering the KS-PRET-5M corpus into multi-font Nastaliq images with 25+ degradation augmentations, for Kashmiri OCR). In-progress: "KS-PRET-5M: 5 Million Word, 12 Million Token Kashmiri Pretraining Corpus" (low-resource NLP, arXiv).
